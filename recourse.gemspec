...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'bh', '>= 6.10' # Bootstrap 6: the stylesheet, the script and the components
  ...
  spec.add_dependency 'unicon', '>= 3.7' # names every icon drawn, in Bootstrap Icons
end
