...
module NavigableHelper
  ...
  NAVIGATION_ICONS = {
    ...
    'Benches' => 'pin-map', 'Bookings' => 'calendar-check', 'Brands' => 'buildings',
    'Campaigns' => 'megaphone', 'Conversations' => 'chat-dots', 'Counties' => 'map',
    'Episodes' => 'collection-play', 'Evaluations' => 'speedometer2', 'Franchises' => 'shop',
    'Logout' => 'box-arrow-right', 'Offer questions' => 'gift', 'Optimizations' => 'sliders',
