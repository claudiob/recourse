...
class TestRecoursesColor < IntegrationCase
  ...
  def test_a_host_picks_a_palette_and_a_name_nobody_ships_is_refused
    ...
    assert_includes body,
                    "<link rel='stylesheet' href='https://design.houseaccount.com/v0.2.0/css/houseaccount.css'>"
    assert_includes body,
    ...
    assert_includes body, 'data-scheme-path-value="https://design.houseaccount.com/v0.2.0/theme"'
