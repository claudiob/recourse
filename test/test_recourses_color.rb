...
class TestRecoursesColor < IntegrationCase
  ...
  def test_a_host_picks_a_palette_and_a_name_nobody_ships_is_refused
    ...
    assert_includes body,
                    "<script type='module' src='https://design.houseaccount.com/v0.5.0/js/houseaccount.js'>"
    ...
    assert_includes body, '<link rel="stylesheet" ' \
                          'href="https://design.houseaccount.com/v0.5.0/theme/dracula.css" ' \
                          'data-recourse-theme="">'
    ...
    assert_includes body, 'data-scheme-path-value="https://design.houseaccount.com/v0.5.0/theme"'
